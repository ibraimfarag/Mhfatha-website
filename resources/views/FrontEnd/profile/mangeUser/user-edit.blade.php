...
<form method="POST" action="{{ route('users.update-profile') }}" enctype="multipart/form-data">
    ...
    <a href="javascript:history.back()" class="btn btn-secondary button_dash float-left mt-2">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="name-group">
                                    ...
                                    <input id="middle_name" type="text" class="form-control" name="middle_name" value="{{ old('middle_name',$user->middle_name) }}">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="name-group">
                                    ...
                                    <select id="city" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city',$user->city) }}" required>
                                ...
                                <div class="name-group">
                                    ...
                                    <select id="region" class="form-control @error('region') is-invalid @enderror" name="region" value="{{ old('region',$user->region) }}" required>
                            ...
                            <div class="form-group">
                                <div class="name-group">
                                    ...
                                    <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile',$user->mobile) }}" required>
                                    @error('mobile')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <img id="image-preview" src="{{ asset('FrontEnd/assets/images/user_images/' .$user->photo) }}" alt="{{$user->name }}" class="img-thumbnail image-preview" >
                            </div>
                            <div class="form-group">
